...
Synchronization was performed by standing still for 10 seconds, jumping 3 times, standing still for another 10 seconds, and then starting the walking bout. Data was then manually synchronized to the jumping point in [sync_imu_data.py](https://github.com/alkvi/imu_comparison/blob/main/sync_imu_data.py).
